...
class TestModelClass(unittest.TestCase):
    ...
    def test_model_init(self):
        ...
        for (n1i, n1j, _, n1w, _), (n2i, n2j, _, n2w, _), ew, _ in edges:
    ...
    def test_model_run(self):
        ...
        model = Model(([
                       ...
                       [
                            ((0, 0, -1, 0, '_'), (1, 0, 1, 1, '_'), 1, 0),
                            ((0, 0, -1, 0, '_'), (1, 1, 2, 0, '_'), -1, 1),
                            ((0, 1, -1, 0, '_'), (1, 1, 2, 0, '_'), -1, 2),
                            ((0, 1, -1, 0, '_'), (3, 1, 7, 0, '_'), 2, 3),
                            ((0, 1, -1, 0, '_'), (1, 2, 3, -1, '_'), 1, 4),
                            ((1, 0, 1, 1, '_'), (2, 0, 4, 0, '_'), 1, 5),
                            ((1, 1, 2, 0, '_'), (2, 0, 4, 0, '_'), 1, 6),
                            ((1, 1, 2, 0, '_'), (2, 1, 5, 1, '_'), -1, 7),
                            ((1, 2, 3, -1, '_'), (2, 1, 5, 1, '_'), 2, 8),
                            ((2, 0, 4, 0, '_'), (3, 0, -1, -1, '_'), 1, 9),
                            ((2, 0, 4, 0, '_'), (3, 1, -1, 0, '_'), -1, 10),
                            ((2, 1, 5, 1, '_'), (3, 0, -1, -1, '_'), 2, 11),
                            ((2, 1, 5, 1, '_'), (3, 1, -1, 0, '_'), -1, 12)
                       ]))
